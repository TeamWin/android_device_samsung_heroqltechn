DEVICE_TREE := device/samsung/heroqltechn
...
TARGET_KERNEL_DEVICE_DEFCONFIG := device_heroqlte_chnzc
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x02200000 --tags_offset 0x02000000 --board RILPA13A000RU
...
TARGET_INIT_VENDOR_LIB := libinit_heroqltechn
TARGET_RECOVERY_DEVICE_MODULES := libinit_heroqltechn
TARGET_LIBINIT_DEFINES_FILE := $(DEVICE_TREE)/init/init_heroqltechn.cpp
